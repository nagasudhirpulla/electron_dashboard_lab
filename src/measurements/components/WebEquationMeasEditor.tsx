...
export const WebEquationMeasEditor: React.FC<{ value: IEquationMeasurement, onChange: (m: IEquationMeasurement) => void }> = ({ value, onChange }) => {
    const propVal = { ...value }
    ...
    return <>
        ...
        {propVal.measurements.map((meas, mInd) =>
            <>
                ...
                <br />
                <WebMeasurementEditor value={meas}
                    onChange={(m) => {
